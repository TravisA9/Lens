...
# ==============================================================================
# calculate the values for colors when between pixels
# ==============================================================================
function subPixelFraction(x,y)
    xa,xb, ya,yb = 1-x,x,  1-y,y
    return ( ya*xa, ya*xb, yb*xa, yb*xb) # bl, br, tl, tr
end
#= related to the subPixelFraction function
...
bl, br, tl, tr = subPixelFraction(Xr,Yr)
...
imgc[x,y] =  RGB(red(r),green(g),blue(b))
